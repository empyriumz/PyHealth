...
if __name__ == "__main__":
    ...
    mimic_data_loc = '/host/TAPER-EHR/data'  # change this to your mimic full data location
    ...
    #################################################################
    # read in tables
    patient_df = read_csv_to_df(os.path.join(mimic_data_loc, 'PATIENTS.csv.gz'))
    ...
    event_df = read_csv_to_df(os.path.join(mimic_data_loc, 'CHARTEVENTS.csv.gz'),
                              usecols=events_vars,
                              dtype=dtypes_dict,
                              low_memory=True)
    ...
    oevent_df = read_csv_to_df(
        os.path.join(mimic_data_loc, 'OUTPUTEVENTS.csv.gz'),
        usecols=events_vars,
        dtype=dtypes_dict,
        low_memory=True)
